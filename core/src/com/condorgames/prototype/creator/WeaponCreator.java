...
import com.condorgames.prototype.entities.equipment.weapons.WeaponProperties.Type;
...
public abstract class WeaponCreator {
  ...
  public static Weapon createRifle() {
    ...
    WeaponPropertiesImpl weaponPropertiesImpl = new WeaponPropertiesImpl(5, Type.RIFLE);
